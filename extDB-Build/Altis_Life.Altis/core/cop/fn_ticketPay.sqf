...
if(life_ozCash < life_ticket_val) exitWith
{
	if(life_ozAtm < life_ticket_val) exitWith 
	{
	...
	life_ozAtm = life_ozAtm - life_ticket_val;
...
life_ozCash = life_ozCash - life_ticket_val;
life_ticket_paid = true;
