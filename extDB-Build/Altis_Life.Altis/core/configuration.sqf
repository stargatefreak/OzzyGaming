...
life_thirst = 100;
life_hunger = 100;
__CONST__(life_ozPaycheck_period,5); //Five minutes
life_ozCash = 0;
...
switch (playerSide) do
{
	case west: 
	{
		life_ozAtm = 60000; //Starting Bank Money
		life_ozPaycheck = 1400; //Paycheck Amount
	};
	case civilian: 
	{
		life_ozAtm = 60000; //Starting Bank Money
		life_ozPaycheck = 1000; //Paycheck Amount
	};
	
	case independent: 
	{
		life_ozAtm = 60000;
		life_ozPaycheck = 4000;
	};
};
