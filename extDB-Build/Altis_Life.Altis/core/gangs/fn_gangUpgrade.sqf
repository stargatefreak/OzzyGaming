...
if(_action) then {
	if(life_ozAtm < _upgradePrice) exitWith {
		hint parseText format[
			...
			[life_ozAtm] call life_fnc_numberText,
			[_upgradePrice - life_ozAtm] call life_fnc_numberText
		];
	};
	__SUB__(life_ozAtm,_upgradePrice);
