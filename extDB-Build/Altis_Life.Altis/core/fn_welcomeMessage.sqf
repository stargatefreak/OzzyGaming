...
_role2names = ["If you are killed you cannot rejoin the engagement you were killed in."]; 
_role3 = "Use the Map!";
...
_role4 = "Team-speak";
_role4names = ["Feel free to join our team-speak if necessary at ts3.ozzygaming.com"]; 
_role5 = "Website";
_role5names = ["You can view our website at http://www.OzzyGaming.com"];
_role6 = "Police";
_role6names = ["Police officers MUST be on team-speak at all times. No exceptions."];
_role7 = "Civilians";
_role7names = ["As a Civilian, please do not troll or needlessly provoke police officers."];
_role8 = "Rebels";
_role8names = ["Be sure to role-play every scenario. Being a rebel does not mean you can shoot anyone at will."];
_role9 = "Killing";
_role9names = ["Death Messages are saved to a log file, if you act like an ass you will be caught."];
...
_role11 = "Admins";
_role11names = ["You can contact any of the Admins on any query, Simply MSG an admin through your phone."];
