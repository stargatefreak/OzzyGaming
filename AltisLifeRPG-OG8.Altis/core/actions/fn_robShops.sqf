...
*/
private["_robber","_shop","_kassa","_ui","_progress","_pgText","_cP","_rip","_pos","_badweaps"];
...
_badweaps = ["Binocular","Rangefinder","NVGoggles","NVGoggles_OPFOR","NVGoggles_INDEP","Laserdesignator",""];
if (currentWeapon _robber in _badweaps) exitWith { hint "HaHa, you do not threaten me! Get out of here you hobo!" };
...
life_ogCash415 = life_ogCash415 + _kassa;
