...
switch (_var) do
{
	...
	case "life_inv_goldore": {"Unwashed Gold Ore"};
	case "life_inv_goldw": {"Washed Gold Ore"};
	case "life_inv_goldr": {"Gold Dust"};
	case "life_inv_gold": {"Smelted Gold"};
	...
	case "license_pmc_basic": {"PMC Onduty"};
};
