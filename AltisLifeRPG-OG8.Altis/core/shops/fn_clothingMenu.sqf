...
// PMC rank check
if((_this select 3) in ["pmc"] && playerSide != civilian) exitWith { hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
if((_this select 3) in ["pmc"] && (__GETC__(life_ozPmclvl) == 0)) exitWith { hint localize "STR_Shop_NotPmc"; closeDialog 0;};
