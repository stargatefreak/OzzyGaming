...
if(life_ogCash415 < life_ticket_val) exitWith
{
	if(life_ogBank415 < life_ticket_val) exitWith 
	{
	...
	life_ogBank415 = life_ogBank415 - life_ticket_val;
...
life_ogCash415 = life_ogCash415 - life_ticket_val;
life_ticket_paid = true;
