...
*/
private["_vehicle","_impound","_vInfo","_vInfo","_plate","_uid","_query","_sql","_unit","_price"];
...
life_garage_service = false;
(owner _unit) publicVariableClient "life_garage_service";
[[1,format["The %1 has been serviced for $%2",typeOf _vehicle,_price]],"life_fnc_broadcast",(owner _unit),false] spawn life_fnc_MP;
